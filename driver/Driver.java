...
public class Driver {
    ...
    static DoublyLinkedList<Vocab> vocabList=new DoublyLinkedList<>();
     ...
     * @return a {@link DoublyLinkedList} containing {@link Vocab} objects loaded from the file.
     *         Each {@link Vocab} object consists of a topic and a {@link SinglyLinkedList} of words.
     * @throws IOException if an input or output exception occurred
    */

    public static DoublyLinkedList<Vocab> loadVocab(String filename){
